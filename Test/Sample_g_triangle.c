...
int main()
{
    ...
    for(i_time = 0;;i_time++)
    {
        ...
        g_triangle_2D(-0.5,-1.5,-1.5,1.5,-1.5,-1.5,0);
		
        g_area_color_2D(1, 0, 0,1);
        g_triangle_2D(1,-1.5,0,-1.5,1,1.5,1);
        ...
        g_line_color(1, 0, 0, 1);
        g_triangle_3D(0,-2.5,0,0,0.5,2,0,2.5,2,0);
		
        g_area_color_3D(1, 0, 0, 1);
        g_triangle_3D(2,-0.5,0,-2.5,0,0,2,-0.5,2,1);
