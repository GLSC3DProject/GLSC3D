...
int main()
{
	...
	g_def_scale_3D_fix(1, -2, 2, -2, 2, -2, 2, 4, 4, 4, 0, 1, 0, 1, GRID_SIZE, 0, GRID_SIZE, GRID_SIZE);

	g_def_scale_2D(2, -2, 2, -2, 2, 0, GRID_SIZE, GRID_SIZE, GRID_SIZE);
	g_def_scale_3D_fix(3, -2, 2, -2, 2, -2, 2, 4, 4, 4, 0, 1, 0, 1, GRID_SIZE, GRID_SIZE, GRID_SIZE, GRID_SIZE);
